...
import { useChangeEmail } from "../../hooks/settings/useChangeEmail";
			...
			<div className="z-10 bg-[#121212] border border-gray-800 rounded-2xl p-10 shadow-2xl w-[900px] flex gap-10">
				<div className="w-1/2">
					<div className="text-left mb-8">
						<h1 className="text-3xl font-bold mb-2">Change Your Email</h1>
					</div>

					<form onSubmit={handleSubmit(submit)} className="flex flex-col gap-3">
						{errors.newEmail && (
							<p className="text-red-500 text-xs">{errors.newEmail.message}</p>
						)}
						<MyInput
							type="text"
							placeholder="New Email"
							{...register("newEmail", { required: "This field is required" })}
						/>
